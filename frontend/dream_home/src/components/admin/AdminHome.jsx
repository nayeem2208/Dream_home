  ...
  return (
    <div className="flex">
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ml-3 text-sm  rounded-lg sm:hidden bg-lime-600 hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-gray-600"
      >
      ...
      <aside
        id="default-sidebar"
        className="fixed  left-0 z-40 w-64 mt-14 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-lime-600">
